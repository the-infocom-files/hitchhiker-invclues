...
<OBJECT MEMORIAL
	...
	(SYNONYM MEMORIAL LIST REMEMBRAN MONUMENT)
	(ADJECTIVE SANDSTONE)
...
absentmindedness. (Its mind is very very small and quite frequently absent.)
...
<OBJECT BEAST
	...
	(SYNONYM BEAST TRAAL)
	(ADJECTIVE RAVENOUS BUGBLATTE BEAST)
	(FLAGS ACTORBIT)
	(ACTION BEAST-F)>
...
" and life in the Universe has to carry on without you.">
		...
		<COND (<EQUAL? ,BEAST-COUNTER 1>
		       <TELL
"With a head-splitting roar, the " D ,BEAST " charges towards you." CR>)
...
\"Nutrimat/Computer Interface.\"") 
	(SYNONYM SKELETON BEASTHUNT BONE BONES)
...
<OBJECT MICROSCOPIC-FLEET
	...
	(ADJECTIVE BATTLE HORRIBLE BEWEAPONE MICROSCOP SPACE VAST)
	(FLAGS NDESCBIT)
...
<OBJECT VLHURG
	...
	(SYNONYM VL\'HURG LEADER CREATURE CREATURES)
	(ADJECTIVE VL\'HURG)
	(FLAGS ACTORBIT)
	(ACTION VLHURG-F)>
...
<OBJECT GGUGVUNT
	...
	(SYNONYM G\'GUGVUNT LEADER CREATURE CREATURES)
	(ADJECTIVE G\'GUGVUNT)
...
<OBJECT THIRD-PLANET
	...
	(ADJECTIVE THIRD BLUE BLUE-GREE GREEN SMALL)
	(FLAGS NDESCBIT)
...
<ROOM MAZE
      (LOC ROOMS)
      (SYNONYM INFOCOM ADAMS MERETZKY)
      (ADJECTIVE DOUGLAS STEVE STEVEN)
      (DESC "Maze")
      (LDESC
...
to be some faint markings on it.")
	(SYNONYM PARTICLE SENSE LETTER MARKINGS)
...
<OBJECT APPETIZERS
	...
	(SYNONYM PLATE D\'OEUVRES APPETIZER SNACKS)
	(ADJECTIVE HORS)
...
<OBJECT JACKET-FLUFF
	...
	(DESC "jacket fluff")
	(SYNONYM FLUFF LINT)
	(ADJECTIVE JACKET UNSIGHTLY)
	(FLAGS NARTICLEBIT TAKEBIT TRYTAKEBIT NDESCBIT)
	(GENERIC POCKET-FLUFF)>

<OBJECT CAGE
	(LOC LOCAL-GLOBALS) ;"for the purposes of MOBY-FIND"
	(DESC "it")
	(SYNONYM DRAPE CAGE BIRDCAGE SNORING)
...
<ROOM SPEEDBOAT
      ...
      (GLOBAL CONTROLS DAMOGRAN PLATFORM CROWD WATER)
      (ACTION SPEEDBOAT-F)>
...
<OBJECT BOAT-OBJECT
	(LOC SPEEDBOAT)
	(DESC "speedboat")
	(SYNONYM SPEEDBOAT BOAT)
	(ADJECTIVE PRESIDENT SPEED)
	(FLAGS NDESCBIT)
...
<OBJECT AUTOPILOT-BUTTON
	...
	(SYNONYM BUTTON PILOT AUTOPILOT)
	(ADJECTIVE AUTOPILOT AUTO LARGE RED)
...
<ROOM DAIS
      ...
      (SYNONYM POLICE COPS)
      (DESC "Dais")
      (SOUTH SORRY "The boat is gone.")
      (EAST PER DAIS-EXIT-F)
      (IN PER DAIS-EXIT-F)
      (OUT PER DAIS-EXIT-F)
      (FLAGS RLANDBIT ONBIT OUTSIDEBIT)
      (GLOBAL HEART-OF-GOLD DAMOGRAN PLATFORM CROWD)
      (ACTION DAIS-F)>
...
"Several members of the crowd are holding a huge banner. ">)>
		...
		<COND (<IN? ,RIFLES ,GUARDS>
		       <TELL ". A semicircle of guards are aiming photon rifles at you and " D ,TRILLIAN>)
		      (<IN? ,GUARDS ,HERE>
		       <TELL
...
<ROUTINE DAIS-FUNCTION ()
	 <COND (<VERB? QUIT RESTART RESTORE SCORE VERSION SAVE ;AGAIN WALK
		       VERBOSE BRIEF SUPERBRIEF SCRIPT UNSCRIPT FOOTNOTE
		       LOOK INVENTORY HINTS WHO WHAT WHERE WHY YES NO THROUGH>
		<>)
	       (<AND <PRSO? ,BANNER ,CROWD>
...
and points a blaster at your left head. Guards rush up, photon rifles poised
...
<OBJECT RIFLES
	(LOC LOCAL-GLOBALS) ;"for purposes of MOBY-FIND"
	(DESC "pile of photon rifles")
	(SYNONYM RIFLE RIFLES PILE WEAPON WEAPONS)
...
but they know what to do with a photon rifle.">
		<RTRUE>)>>
